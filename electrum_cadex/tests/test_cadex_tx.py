...
from electrum_cadex.util import bh2u, bfh
...
class TestCadexSpecTxSerialization(SequentialTestCase):

    def test_cadex_tx_v2(self):
    ...
    def test_cadex_tx_pro_reg_tx(self):
    ...
    def test_cadex_tx_pro_up_serv_tx(self):
    ...
    def test_cadex_tx_pro_up_reg_tx(self):
    ...
    def test_cadex_tx_pro_up_rev_tx(self):
    ...
    def test_cadex_tx_sub_tx_register(self):
    ...
    def test_cadex_tx_sub_tx_topup(self):
    ...
    def test_cadex_tx_sub_tx_reset_key(self):
    ...
    def test_cadex_tx_sub_tx_close_account(self):
    ...
    def test_cadex_tx_unknown_spec_tx(self):
    ...
    def test_cadex_tx_wrong_spec_tx(self):
