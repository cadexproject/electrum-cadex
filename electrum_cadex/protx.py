...
from .cadex_tx import (TxOutPoint, ProTxService, CadexProRegTx, CadexProUpServTx,
                      CadexProUpRegTx, CadexProUpRevTx, CadexCbTx)
...
class PartialMerkleTree(namedtuple('PartialMerkleTree', 'total hashes flags')):
    '''Class representing CPartialMerkleTree of cadexd'''
    @classmethod
...
class ProTxManager(PrintError):
    ...
    def prepare_pro_reg_tx(self, alias):
        ...
        tx = CadexProRegTx(1, mn.type, mn.mode, mn.collateral, mn.service.ip,
    ...
    def prepare_pro_up_srv_tx(self, mn):
        ...
        tx = CadexProUpServTx(1, bfh(mn.protx_hash)[::-1],
    ...
    def prepare_pro_up_reg_tx(self, mn):
        ...
        tx = CadexProUpRegTx(1, bfh(mn.protx_hash)[::-1], mn.mode,
    ...
    def prepare_pro_up_rev_tx(self, alias, reason):
        ...
        tx = CadexProUpRevTx(1, bfh(mn.protx_hash)[::-1], reason,
                            b'\x00'*32, b'\x00'*96)
        return tx
    ...
    def on_protx_diff(self, key, value):
        ...
        if not isinstance(cbtx_extra, CadexCbTx):
