...
_ = lambda x:x
#from i18n import _
from electrum_cadex import WalletStorage, Wallet
from electrum_cadex.cadex_tx import SPEC_TX_NAMES
from electrum_cadex.util import format_satoshis, set_verbosity
from electrum_cadex.bitcoin import is_address, COIN, TYPE_ADDRESS
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-cadex create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-cadex setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-cadex setconfig' to change your settings")
        return True
