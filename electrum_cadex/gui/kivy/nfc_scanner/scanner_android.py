...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.cadex.electrum.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.cadex.electrum"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.cadex.electrum:externalType",
                '',
                data)
        return extRecord
