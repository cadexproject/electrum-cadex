...
from electrum_cadex.bitcoin import TYPE_ADDRESS
from electrum_cadex.storage import WalletStorage
from electrum_cadex.wallet import Wallet
from electrum_cadex.paymentrequest import InvoiceStore
from electrum_cadex.util import profiler, InvalidPassword
from electrum_cadex.plugin import run_hook
from electrum_cadex.util import format_satoshis, format_satoshis_plain
from electrum_cadex.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
from .i18n import _
...
#Factory.register('InstallWizard', module='electrum_cadex.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_cadex.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_cadex.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_cadex.gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_cadex_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_cadex.gui.kivy.uix.screens')

# Register fonts without this you won't be able to use bold/italic...
# inside markup.
from kivy.core.text import Label
Label.register('Roboto',
               'electrum_cadex/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_cadex/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_cadex/gui/kivy/data/fonts/Roboto-Bold.ttf',
               'electrum_cadex/gui/kivy/data/fonts/Roboto-Bold.ttf')


from electrum_cadex.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from electrum_cadex import constants
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_cadex.util import format_time
        requestor = req.get('requestor')
        exp = req.get('exp')
        memo = req.get('memo')
        amount = req.get('amount')
        fund = req.get('fund')
        popup = Builder.load_file('electrum_cadex/gui/kivy/uix/ui_screens/invoice.kv')
    ...
    def scan_qr(self, on_complete):
        ...
        SimpleScannerActivity = autoclass("org.cadex.electrum.qr.SimpleScannerActivity")
    ...
    def build(self):
        return Builder.load_file('electrum_cadex/gui/kivy/main.kv')
    ...
    def on_start(self):
        ...
        # bind intent for cadex: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def show_tor_warning(self):
        ...
        img_error = 'atlas://electrum_cadex/gui/kivy/theming/light/error'
    ...
    def load_wallet_by_name(self, path, ask_if_wizard=False):
        ...
        if wallet:
            ...
            Logger.debug('Cadex Electrum: Wallet not found or action needed. Launching install wizard')
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('electrum_cadex/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_cadex.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_cadex.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_cadex_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_cadex_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-cadex.png"
    ...
    def get_max_amount(self):
        from electrum_cadex.transaction import TxOutput
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Cadex Electrum', message,
                            app_icon=icon, app_name='Cadex Electrum')
        except ImportError:
    ...
    def show_error(self, error, width='200dp', pos=None, arrow_pos=None,
        exit=False, icon='atlas://electrum_cadex/gui/kivy/theming/light/error', duration=0,
        modal=False):
    ...
    def show_info(self, error, width='200dp', pos=None, arrow_pos=None,
        ...
        '''
        self.show_error(error, icon='atlas://electrum_cadex/gui/kivy/theming/light/important',
    ...
    def show_info_bubble(self, text=_('Hello World'), pos=None, duration=0,
        ...
        if text == 'texture':
            ...
            info_bubble.background_image = 'atlas://electrum_cadex/gui/kivy/theming/light/card'
        else:
