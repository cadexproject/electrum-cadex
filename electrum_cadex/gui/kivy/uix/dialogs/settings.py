...
from electrum_cadex.util import base_units_list
...
from electrum_cadex import coinchooser
...
<SettingsDialog@Popup>
    id: settings
    title: _('Cadex Electrum Settings')
    disable_pin: False
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Cadex amounts.")
...
class SettingsDialog(Factory.Popup):
    ...
    def proxy_dialog(self, item, dt):
        if self._proxy_dialog is None:
            ...
            popup = Builder.load_file('electrum_cadex/gui/kivy/uix/ui_screens/proxy.kv')
