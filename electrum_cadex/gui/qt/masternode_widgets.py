...
from electrum_cadex.bitcoin import COIN
from electrum_cadex.i18n import _
from electrum_cadex.masternode import NetworkAddress, MasternodeAnnounce
...
class PrevOutWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.hash_edit.setPlaceholderText(_('The TxID of your 100000 KDX output'))
        self.index_edit = QLineEdit()
        self.index_edit.setPlaceholderText(_('The output number of your 100000 KDX output'))
        self.address_edit = QLineEdit()
        self.address_edit.setPlaceholderText(_('The address that 100000 KDX was sent to'))
...
class MasternodeOutputsTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        desc = ' '.join(['Use this tab to scan for and choose a collateral payment for your masternode.',
            'A valid collateral payment is exactly 100000 KDX.'])
        desc = QLabel(_(desc))
    ...
    def scan_for_outputs(self, include_frozen):
        ...
        if len(coins) > 0:
            ...
            self.status_edit.setText(_('No 100000 KDX outputs were found.'))
    ...
    def set_mapper_index(self, row):
        ...
        if mn.vin.get('value', 0) == COIN * 100000:
            can_scan = False
...
class SignAnnounceWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        form = QFormLayout()
        form.addRow(_('Alias:'), self.alias_edit)
        form.addRow(_('Collateral KDX Output:'), self.collateral_edit)
