...
from electrum_cadex.bitcoin import (TYPE_ADDRESS, int_to_hex, var_int,
...
from electrum_cadex.util import print_error, bfh, bh2u, versiontuple
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise Exception(_("Device not in Cadex mode")) from e
                raise e
