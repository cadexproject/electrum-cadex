...
from electrum_cadex.util import bfh, bh2u, versiontuple, UserCancelled
from electrum_cadex.bitcoin import (b58_address_to_hash160, xpub_from_pubkey, deserialize_xpub,
                                   TYPE_ADDRESS, TYPE_SCRIPT, is_address)
from electrum_cadex import constants
from electrum_cadex.i18n import _
from electrum_cadex.plugin import BasePlugin, Device
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Cadex Testnet" if constants.net.TESTNET else "Cadex"
