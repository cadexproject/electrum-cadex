...
class MasternodeManager(object):
    ...
    def get_masternode_outputs(self, domain = None, exclude_frozen = True):
        ...
        correct_amount = lambda d: d['value'] == 100000 * bitcoin.COIN

        # Valid outputs have a value of exactly 100000 KDX and
    ...
    def check_can_sign_masternode(self, alias):
        ...
        if mn.vin.get('value', 0) != bitcoin.COIN * 100000:
            raise Exception('Masternode requires a collateral 100000 KDX output.')
