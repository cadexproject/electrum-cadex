...
exe = EXE(pyz,
          ...
          name=os.path.join('build/electrum-cadex/electrum-cadex', cmdline_name))
...
tctl_exe = EXE(tctl_pyz,
           ...
           upx=False,
           console=True,
           name=os.path.join('build/electrum-cadex/electrum-cadex', 'trezorctl.bin'))
...
app = BUNDLE(coll,
             name=os.path.join('dist', 'Cadex Electrum.app'),
             appname="Cadex Electrum",
	         icon='electrum-cadex.icns',
