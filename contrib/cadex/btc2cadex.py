#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Search and replaces BTC addresses and private keys in WIF to CADEX variant"""

import click
import imp
import re

imp.load_module('electrum_cadex', *imp.find_module('../../electrum_cadex'))

from electrum_cadex import constants
from electrum_cadex.bitcoin import (b58_address_to_hash160, hash160_to_b58_address,
                         serialize_privkey, DecodeBase58Check, WIF_SCRIPT_TYPES)
from electrum_cadex.util import inv_dict
